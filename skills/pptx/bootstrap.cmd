...
REM No Chromium download. html2pptx renders via playwright-core's connectOverCDP
REM against the host's agent-browser Chrome (see scripts/html2pptx.js).

echo [bootstrap] verifying installation...
call node -e "require('pptxgenjs');require('playwright-core');require('sharp');console.log('[bootstrap] all deps require() OK');"
if errorlevel 1 exit /b 1
